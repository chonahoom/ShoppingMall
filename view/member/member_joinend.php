...
<?php
	$member_ctr = new Member_controller();
 	$member_ctr->member_joined_sql_controller(); 	
							...
							<tr>
								<td align="center">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											<td height="30">
												...
												저희 쇼핑몰은 항상 최상의 쌀을 제공할 것을 약속 드립니다.<br><br><br><br><br>
												재미있는 쌀 드립이 생각나면 언제든 연락 주세요.</font><br><br><br>
									...
									<table border='0' align=right>
										<tr>
											<td>
												<a href="index.php"><img src="images/shopping_start.png" width='60px' height='60px'></a>
											</td>
										</tr>
									</table>
								</td>
